...
const faveColors = ['pink', 'purple', 'green']
...
const me= {
    ...
    superHeroName: 'Superwoman',
    homeTown: 'Somewhere far-far-away',
    superPowers: ['Flying', 'Shooting cats from the eyeballs', 'Eating pie']
    // superPowerXP: (math.random() * 100) +1)
...
obj.keys(redactInfo).forEach(function(key){ obj[key] = "redacted" ;});
