...
// 		if([i] > 100){
// 			arr = answers.push('big')
// 		} else {
// 			arr = answers.push('small')
// 		}
// 	}
// 	return answers
// }
...
total = myNumbers.reduce(function (n) {return (3 + 55 + 788 + 2 + 1)/5;});
...
myNumbersIndex = myNumbers.forEach(function (n) {return myNumbersIndex.push();});
...
forTheLoveOfGeorge = notGeorge.map(function (n) { return 'George'; });
...
var enemies = []
enemies = people.name.friend.filter(function (e) {return enemies.push();});
...
var totallyAwesome = undefined;
totallyAwesome = people.awesomeLevel.reduce(function (e) {return 10 + 10 + 3 + 4 + 8 + 7});
